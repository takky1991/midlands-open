...
@section('container')
    ...
    <div class="mma-register-page">
        ...
        @else
            ...
            <form role="form" action="{{url('/mma/register')}}" method="POST">
                {{csrf_field()}}
                <div class="row">
                    ...
                    <div class="checkbox col-xs-12">
                        <label>
                            <input type="checkbox" name="terms_conditions" id="terms_conditions"> I have read and understand the <a href="{{route('mma_terms_conditions')}}" target="_blank">Terms & Conditions</a>.
                        </label>
